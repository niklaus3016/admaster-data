...
export function useAdManager(config: AdConfig) {
  ...
  // 广告位分组配置（明序性格测试 B版，含1个竞价位20287710）
  const AD_GROUPS = {
    group1: [
      '20287646', // 保价1650
      '20287652', // 保价1150
    ...
    group4: [
      '20287709', // 保价80
      '20287710', // 竞价(setbid:5000)
      '20287713', // 保价0
    ],
  }; // 共12个广告位（明序性格测试 B版，含1个竞价位20287710）
  ...
  const generateSimulatedEcpm = (slotId: string): number => {
    const ecpmRanges: { [key: string]: [number, number] } = {
      // group1 - 保价1650, 1150, 750
      '20287646': [1485, 1650], // 保价1650
      '20287652': [1035, 1150], // 保价1150
      '20287665': [675, 750],   // 保价750
      // group2 - 保价550, 450, 350
      '20287682': [495, 550],   // 保价550
      '20287695': [405, 450],   // 保价450
      '20287687': [315, 350],   // 保价350
      // group3 - 保价250, 180, 130
      '20287697': [225, 250],   // 保价250
      '20287702': [162, 180],   // 保价180
      '20287704': [117, 130],   // 保价130
      // group4 - 保价80, 竞价, 保价0
      '20287709': [72, 80],     // 保价80
      '20287710': [45, 50],     // 竞价(setbid:5000)
      '20287713': [20, 24],     // 保价0
    };
