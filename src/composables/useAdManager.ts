...
export function useAdManager(config: AdConfig) {
  ...
  // 广告位分组配置（极序测速 0901，含1个竞价位19485371）
  const AD_GROUPS = {
    group1: [
      '19485322', // 保价1500
      '19485324', // 保价1000
    ...
    group5: [
      '19485360', // 保价80
      '19485371', // 竞价(setbid:5000)
      '19485388', // 保价0
    ],
  }; // 共15个广告位（极序测速 0901，含1个竞价位19485371）
  ...
  const generateSimulatedEcpm = (slotId: string): number => {
    const ecpmRanges: { [key: string]: [number, number] } = {
      ...
      '19485322': [1200, 1500], // 保价1500
      '19485324': [800, 1000],  // 保价1000
      '19485326': [720, 900],   // 保价900
      // group2 - 保价800, 700, 600
      '19501809': [640, 800],   // 保价800
      '19501810': [560, 700],   // 保价700
      '19485330': [480, 600],   // 保价600
      // group3 - 保价500, 400, 300
      '19501811': [400, 500],   // 保价500
      '19485332': [320, 400],   // 保价400
      '20262576': [240, 300],   // 保价300
      // group4 - 保价200, 150, 130
      '19485348': [180, 200],   // 保价200
      '19485350': [135, 150],   // 保价150
      '19485353': [117, 130],   // 保价130
      // group5 - 保价80, 竞价, 保价0
      '19485360': [72, 80],     // 保价80
      '19485371': [40, 50],     // 竞价(setbid:5000)
      '19485388': [20, 24],     // 保价0
    };
