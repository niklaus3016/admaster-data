...
export function useAdManager(config: AdConfig) {
  ...
  const generateSimulatedEcpm = (slotId: string): number => {
    const ecpmRanges: { [key: string]: [number, number] } = {
      // group1 - 保价800, 500, 400
      '20119045': [640, 720],    // 保价800
      '20119048': [400, 450],    // 保价500
      '19361453': [320, 360],    // 保价400
      // group2 - 保价300, 250, 200
      '19950604': [240, 270],    // 保价300
      '20119051': [225, 250],    // 保价250
      '19361461': [180, 200],    // 保价200
      // group3 - 保价150, 120, 80
      '19361483': [135, 150],    // 保价150
      '20119055': [108, 120],    // 保价120
      '19361502': [72, 80],      // 保价80
      // group4 - 保价40, 竞价, 保价0
      '20081479': [36, 40],      // 保价40
      '20119056': [20, 25],      // 竞价
