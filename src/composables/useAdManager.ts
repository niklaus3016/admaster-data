...
export function useAdManager(config: AdConfig) {
  ...
  // 广告位分组配置（美序名片 0909，含1个竞价位20423469）
  const AD_GROUPS = {
    group1: [
      '20423295', // 保价1450
      '20423322', // 保价1250
    ...
    group6: [
      '20423463', // 保价50
      '20423469', // 竞价(setfloor:3000)
      '20423485', // 保价0
    ],
  }; // 共18个广告位（美序名片 0909，含1个竞价位20423469）
  ...
  const generateSimulatedEcpm = (slotId: string): number => {
    const ecpmRanges: { [key: string]: [number, number] } = {
      // group1 - 保价1450, 1250, 1050
      '20423295': [1160, 1450],  // 保价1450
      '20423322': [1000, 1250],  // 保价1250
      '20423328': [840, 1050],   // 保价1050
      // group2 - 保价850, 750, 650
      '20423330': [680, 850],    // 保价850
      '20423341': [600, 750],    // 保价750
      '20423360': [520, 650],   // 保价650
      // group3 - 保价500, 400, 300
      '20423390': [400, 500],    // 保价500
      '20423402': [320, 400],    // 保价400
      '20423416': [240, 300],    // 保价300
      // group4 - 保价250, 200, 150
      '20423424': [200, 250],    // 保价250
      '20423430': [160, 200],    // 保价200
      '20423433': [135, 150],    // 保价150
      // group5 - 保价130, 100, 80
      '20423444': [117, 130],    // 保价130
      '20423451': [90, 100],     // 保价100
      '20423460': [72, 80],      // 保价80
      // group6 - 保价50, 竞价, 保价0
      '20423463': [40, 50],      // 保价50
      '20423469': [20, 30],      // 竞价(setfloor:3000)
      '20423485': [10, 10],      // 保价0
    };
