...
export function useAdManager(config: AdConfig) {
  ...
  const generateSimulatedEcpm = (slotId: string): number => {
    const ecpmRanges: { [key: string]: [number, number] } = {
      // group1 - 保价1800, 1500, 1200
      '20129752': [1440, 1620],  // 保价1800
      '20129764': [1200, 1350],  // 保价1500
      '20129766': [960, 1080],   // 保价1200
      // group2 - 保价900, 700, 500
      '20129781': [720, 810],    // 保价900
      '20129782': [560, 630],    // 保价700
      '20129785': [400, 450],    // 保价500
      // group3 - 保价450, 400, 350
      '20129787': [360, 405],    // 保价450
      '20129788': [320, 360],    // 保价400
      '20129793': [280, 315],    // 保价350
      // group4 - 保价300, 250, 200
      '20129800': [270, 300],    // 保价300
      '20129805': [225, 250],    // 保价250
      '20129808': [180, 200],    // 保价200
      // group5 - 保价150, 120, 90
      '20129818': [135, 150],    // 保价150
