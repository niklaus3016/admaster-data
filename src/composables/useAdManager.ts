...
export function useAdManager(config: AdConfig) {
  ...
  const AD_GROUPS = {
    ...
    group4: [
      '20248250', // 保价120
      '20261921', // 竞价(setbid:10000)
      '20248256', // 保价80
    ],
    group5: [
      '20248264', // 保价50
      '20261914', // 竞价(setbid:3000)
      '20248288', // 保价0
    ],
  }; // 共14个广告位（静序念经C版）
  ...
  const generateSimulatedEcpm = (slotId: string): number => {
    const ecpmRanges: { [key: string]: [number, number] } = {
      ...
      // group4 - 保价120, 竞价, 保价80
      '20248250': [108, 120],    // 保价120
      '20261921': [20, 24],      // 竞价(setbid:10000)
      '20248256': [72, 80],      // 保价80
      // group5 - 保价50, 竞价, 保价0
      '20248264': [45, 50],      // 保价50
      '20261914': [20, 24],      // 竞价(setbid:3000)
      '20248288': [20, 24],      // 保价0
    };
