...
export function useAdManager(config: AdConfig) {
  ...
  const generateSimulatedEcpm = (slotId: string): number => {
    const ecpmRanges: { [key: string]: [number, number] } = {
      ...
      '20167939': [900, 1000],   // 保价1000
      '20168003': [720, 800],    // 保价800
      '20168019': [540, 600],    // 保价600
      // group2 - 保价500, 400, 350
      '20162341': [450, 500],    // 保价500
      '20162342': [360, 400],    // 保价400
      '20168039': [315, 350],    // 保价350
