...
export function useAdManager(config: AdConfig) {
  ...
  // 广告位分组配置（静序念经 0901，含1个竞价位20261914）
  const AD_GROUPS = {
    group1: [
      '20248145', // 保价1450
      '20248150', // 保价1250
    ...
    group5: [
      '20261914', // 竞价(setbid:5000)
      '20248264', // 保价50
      '20292524', // 保价0
    ],
  }; // 共15个广告位（静序念经 0901，含1个竞价位20261914）
  ...
  const generateSimulatedEcpm = (slotId: string): number => {
    const ecpmRanges: { [key: string]: [number, number] } = {
      // group1 - 保价1450, 1250, 850
      '20248145': [1160, 1450], // 保价1450
      '20248150': [1000, 1250], // 保价1250
      '20248171': [680, 850],   // 保价850
      // group2 - 保价750, 650, 450
      '20248191': [600, 750],   // 保价750
      '20248195': [520, 650],   // 保价650
      '20248210': [360, 450],   // 保价450
      // group3 - 保价350, 250, 200
      '20248219': [280, 350],   // 保价350
      '20248230': [200, 250],   // 保价250
      '20248245': [180, 200],   // 保价200
      // group4 - 保价150, 120, 80
      '20248246': [135, 150],   // 保价150
      '20248250': [108, 120],   // 保价120
      '20248256': [72, 80],     // 保价80
      // group5 - 竞价, 保价50, 保价0
      '20261914': [40, 50],     // 竞价(setbid:5000)
      '20248264': [40, 50],     // 保价50
      '20292524': [20, 24],     // 保价0
    };
