...
export function useAdManager(config: AdConfig) {
  ...
  // 广告位分组配置（月序星座 0901，含1个竞价位20292763）
  const AD_GROUPS = {
    group1: [
      '19361382', // 保价1500
      '19361408', // 保价1000
    ...
    group5: [
      '20081479', // 保价40
      '20292763', // 竞价(setbid:3000)
      '19361517', // 保价0
    ],
  }; // 共15个广告位（月序星座 0901，含1个竞价位20292763）
  ...
  const generateSimulatedEcpm = (slotId: string): number => {
    const ecpmRanges: { [key: string]: [number, number] } = {
      ...
      // group4 - 保价100, 80, 60
      '20081473': [90, 100],    // 保价100
      '19361502': [72, 80],     // 保价80
      '20081475': [54, 60],     // 保价60
      // group5 - 保价40, 竞价, 保价0
      '20081479': [36, 40],     // 保价40
      '20292763': [20, 30],     // 竞价(setbid:3000)
      '19361517': [20, 24],     // 保价0
    };
