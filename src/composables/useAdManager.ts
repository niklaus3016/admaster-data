...
export function useAdManager(config: AdConfig) {
  ...
  const generateSimulatedEcpm = (slotId: string): number => {
    const ecpmRanges: { [key: string]: [number, number] } = {
      // group1 - 保价600, 450, 400
      '19874715': [540, 600],    // 保价600
      '19909592': [405, 450],    // 保价450
      '19874724': [360, 400],    // 保价400
      // group2 - 保价350, 280, 230
      '19909581': [315, 350],    // 保价350
      '19909579': [252, 280],    // 保价280
      '19909572': [207, 230],    // 保价230
      // group3 - 保价200, 180, 150
      '19874754': [180, 200],    // 保价200
      '19909566': [162, 180],    // 保价180
      '19874779': [135, 150],    // 保价150
      // group4 - 保价130, 100, 80
      '19874820': [117, 130],    // 保价130
      '19909561': [90, 100],     // 保价100
      '19874845': [72, 80],      // 保价80
      // group5 - 保价60, 竞价, 保价0
      '19909557': [54, 60],      // 保价60
      '19874849': [20, 30],      // 竞价
