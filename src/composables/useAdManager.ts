...
export function useAdManager(config: AdConfig) {
  ...
  // 广告位分组配置（知序笔记 0901，含1个竞价位20292487）
  const AD_GROUPS = {
    group1: [
      '20188175', // 保价800
      '20188181', // 保价600
    ...
    group5: [
      '20202246', // 保价60
      '20292487', // 竞价(setbid:3000)
      '20292500', // 保价0
    ],
  }; // 共15个广告位（知序笔记 0901，含1个竞价位20292487）
  ...
  const generateSimulatedEcpm = (slotId: string): number => {
    const ecpmRanges: { [key: string]: [number, number] } = {
      // group1 - 保价800, 600, 500
      '20188175': [560, 700],   // 保价800
      '20188181': [480, 600],   // 保价600
      '20202242': [400, 500],   // 保价500
      // group2 - 保价450, 400, 350
      '20202244': [360, 450],   // 保价450
      '20188188': [320, 400],   // 保价400
      '20188211': [280, 350],   // 保价350
      // group3 - 保价300, 250, 200
      '20188214': [240, 300],   // 保价300
      '20188223': [200, 250],   // 保价250
      '20188231': [180, 200],   // 保价200
      // group4 - 保价160, 120, 80
      '20188265': [144, 160],   // 保价160
      '20188266': [108, 120],   // 保价120
      '20188278': [72, 80],     // 保价80
      // group5 - 保价60, 竞价, 保价0
      '20202246': [54, 60],     // 保价60
      '20292487': [20, 24],     // 竞价(setbid:3000)
      '20292500': [20, 24],     // 保价0
    };
