...
export function useAdManager(config: AdConfig) {
  ...
  // 广告位分组配置（云序择名 0901，含1个竞价位19803395）
  const AD_GROUPS = {
    group1: [
      '19811233', // 保价1100
      '19803374', // 保价1000
    ...
    group5: [
      '19803391', // 保价80
      '19803395', // 竞价(setbid:5000)
      '20123506', // 保价0
    ],
  }; // 共15个广告位（云序择名 0901，含1个竞价位19803395）
  ...
  const generateSimulatedEcpm = (slotId: string): number => {
    const ecpmRanges: { [key: string]: [number, number] } = {
      // group1 - 保价1100, 1000, 900
      '19811233': [990, 1100],  // 保价1100
      '19803374': [900, 1000],  // 保价1000
      '19803376': [810, 900],   // 保价900
      // group2 - 保价600, 400, 350
      '19803379': [540, 600],   // 保价600
      '19803380': [360, 400],   // 保价400
      '19811242': [315, 350],   // 保价350
      // group3 - 保价300, 250, 230
      '19811253': [270, 300],   // 保价300
      '19811290': [225, 250],   // 保价250
      '19825703': [207, 230],   // 保价230
      // group4 - 保价200, 150, 130
      '19803382': [180, 200],   // 保价200
      '19803385': [135, 150],   // 保价150
      '19803386': [117, 130],   // 保价130
      // group5 - 保价80, 竞价, 保价0
      '19803391': [72, 80],     // 保价80
      '19803395': [40, 50],     // 竞价(setbid:5000)
      '20123506': [20, 24],     // 保价0
    };
