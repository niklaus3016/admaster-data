...
export function useAdManager(config: AdConfig) {
  ...
  // 广告位分组配置（梦序塔罗 0901，含1个竞价位19701650）
  const AD_GROUPS = {
    group1: [
      '19701206', // 保价1250
      '19701313', // 保价1050
    ...
    group5: [
      '19717158', // 保价50
      '19701650', // 竞价(setbid:3000)
      '20222434', // 保价0
    ],
  }; // 共15个广告位（梦序塔罗 0901，含1个竞价位19701650）
