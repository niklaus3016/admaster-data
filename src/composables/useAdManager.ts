...
export function useAdManager(config: AdConfig) {
  ...
  const generateSimulatedEcpm = (slotId: string): number => {
    const ecpmRanges: { [key: string]: [number, number] } = {
      ...
      '20262266': [1160, 1450],  // 保价1450
      '20262282': [680, 850],    // 保价850
      '20262304': [520, 650],    // 保价650
      // group2 - 保价450, 350, 250
      '20262307': [360, 450],    // 保价450
      '20262314': [280, 350],    // 保价350
      '20262315': [200, 250],    // 保价250
      // group3 - 保价200, 150, 120
      '19361461': [180, 200],    // 保价200
      '19361483': [135, 150],    // 保价150
      '20262319': [108, 120],    // 保价120
      // group4 - 保价80, 竞价, 保价0
      '20262337': [72, 80],      // 保价80
      '20262348': [20, 24],      // 竞价(setbid:5000)
      '20262349': [20, 24],      // 保价0
    };
