...
export function useAdManager(config: AdConfig) {
  ...
  const generateSimulatedEcpm = (slotId: string): number => {
    const ecpmRanges: { [key: string]: [number, number] } = {
      '19667951': [1710, 1800], // 保价1800
      '19667953': [1425, 1500], // 保价1500
      '19667954': [950, 1000],  // 保价1000
      '19667955': [855, 900],   // 保价900
      '19667964': [570, 600],   // 保价600
      '19667993': [380, 400],   // 保价400
      '19667996': [190, 200],   // 保价200
      '19667999': [135, 150],   // 保价150
      '19668006': [117, 130],   // 保价130
      '19668007': [72, 80],     // 保价80
      '19668008': [20, 40],     // 竞价
      '19668009': [20, 40]      // 保价0
    };
