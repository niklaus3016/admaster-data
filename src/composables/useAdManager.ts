...
export function useAdManager(config: AdConfig) {
  ...
  // 广告位分组配置（问月塔罗 0908，含2个竞价位20344917/20344925）
  const AD_GROUPS = {
    group1: [
      '20344738', // 保价1000
      '20344769', // 保价900
    ...
    group5: [
      '20344915', // 保价100
      '20344917', // 竞价(setbid:10000)
      '20340729', // 保价80
    ],
    group6: [
      '20344925', // 竞价(setbid:5000)
      '20340737', // 保价50
      '20344926', // 保价30
    ],
    group7: [
  ...
  }; // 共19个广告位（问月塔罗 0908，含2个竞价位20344917/20344925）
  ...
  const generateSimulatedEcpm = (slotId: string): number => {
    const ecpmRanges: { [key: string]: [number, number] } = {
      // group1 - 保价1000, 900, 800
      '20344738': [800, 1000],  // 保价1000
      '20344769': [720, 900],   // 保价900
      '20344805': [640, 800],   // 保价800
      // group2 - 保价700, 600, 500
      '20344829': [560, 700],   // 保价700
      '20344858': [480, 600],   // 保价600
      '20344870': [400, 500],   // 保价500
      // group3 - 保价400, 300, 200
      '20344873': [320, 400],   // 保价400
      '20340671': [240, 300],   // 保价300
      '20344884': [160, 200],   // 保价200
      // group4 - 保价180, 150, 120
      '20344904': [162, 180],   // 保价180
      '20340713': [135, 150],   // 保价150
      '20340724': [108, 120],   // 保价120
      // group5 - 保价100, 竞价, 保价80
      '20344915': [90, 100],    // 保价100
      '20344917': [40, 50],     // 竞价(setbid:10000)
      '20340729': [72, 80],     // 保价80
      // group6 - 竞价, 保价50, 保价30
      '20344925': [26, 30],     // 竞价(setbid:5000)
      '20340737': [40, 50],     // 保价50
      '20344926': [26, 30],     // 保价30
      // group7 - 保价0
      '20340764': [10, 18],     // 保价0
