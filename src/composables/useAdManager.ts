...
export function useAdManager(config: AdConfig) {
  ...
  const AD_GROUPS = {
    ...
    group5: [
      ...
      '19188704', '19206292', '19202085', // 800、600、500
      '19188706', '19202092', '19188709', // 400、300、200
      '19202094', '19188421', '19202097', // 180、150、130
      '19183768', '19188420', '19202099', // 100、80、60
      '19188427', '19188657', '19188418'  // 竞价、竞价、30
    ] // 全部串行：共18个广告位
  };
  ...
  const generateSimulatedEcpm = (slotId: string): number => {
    const ecpmRanges: { [key: string]: [number, number] } = {
      '19188425': [1900, 2100], // 保价2000
      '19188698': [1425, 1575], // 保价1500
      '19188424': [950, 1000],  // 保价1000
      '19188704': [760, 800],   // 保价800
      '19206292': [570, 600],   // 保价600
      '19202085': [475, 500],   // 保价500
      '19188706': [380, 400],   // 保价400
      '19202092': [285, 300],   // 保价300
      '19188709': [190, 200],   // 保价200
      '19202094': [171, 180],   // 保价180
      '19188421': [142, 150],   // 保价150
      '19202097': [123, 130],   // 保价130
      '19183768': [95, 100],    // 保价100
      '19188420': [76, 80],     // 保价80
      '19202099': [57, 60],     // 保价60
      '19188427': [20, 40],     // 竞价
      '19188657': [20, 40],     // 竞价
  ...
  const isBiddingSlot = (slotId: string): boolean => {
    const biddingSlots = ['19188427', '19188657'];
  ...
  const preloadNextAd = async (): Promise<void> => {
    ...
    preloadingPromise = (async () => {
      ...
      // 阶段3：最后3个广告位串行
      if (!foundAd) {
        const lastSerialSlots = slotIds.slice(15);
