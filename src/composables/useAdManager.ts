...
export function useAdManager(config: AdConfig) {
  ...
  const generateSimulatedEcpm = (slotId: string): number => {
    const ecpmRanges: { [key: string]: [number, number] } = {
      // group1 - 保价1800, 1000, 600
      '20094312': [1620, 1800],  // 保价1800
      '20094393': [900, 1000],   // 保价1000
      '20094437': [540, 600],    // 保价600
      // group2 - 保价400, 300, 200
      '20094461': [360, 400],    // 保价400
      '20094480': [270, 300],    // 保价300
      '20094503': [180, 200],    // 保价200
      // group3 - 保价150, 130, 100
      '20094535': [135, 150],    // 保价150
      '20094552': [117, 130],    // 保价130
      '20094586': [90, 100],     // 保价100
      // group4 - 保价80, 60, 40
      '20094616': [72, 80],      // 保价80
      '20094683': [54, 60],      // 保价60
      '20094721': [36, 40],      // 保价40
