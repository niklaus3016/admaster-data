...
export function useAdManager(config: AdConfig) {
  ...
  const generateSimulatedEcpm = (slotId: string): number => {
    const ecpmRanges: { [key: string]: [number, number] } = {
      '19485318': [1710, 1800], // 保价1800
      '19485322': [1425, 1500], // 保价1500
      '19485324': [950, 1000],  // 保价1000
      '19485326': [855, 900],   // 保价900
      '19501809': [760, 800],   // 保价800
      '19501810': [665, 700],   // 保价700
      '19485330': [570, 600],   // 保价600
      '19501811': [475, 500],   // 保价500
      '19485332': [380, 400],   // 保价400
      '19485348': [190, 200],   // 保价200
