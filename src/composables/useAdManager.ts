...
export function useAdManager(config: AdConfig) {
  ...
  const generateSimulatedEcpm = (slotId: string): number => {
    const ecpmRanges: { [key: string]: [number, number] } = {
      ...
      '20162337': [1080, 1420],  // 保价1500
      '20162338': [960, 1080],   // 保价1200
      '20162339': [720, 810],    // 保价900
      // group2 - 保价700, 500, 400
      '20162340': [560, 630],    // 保价700
      '20162341': [400, 450],    // 保价500
      '20162342': [320, 360],    // 保价400
      // group3 - 保价300, 250, 200
      '20162343': [270, 300],    // 保价300
      '20162344': [225, 250],    // 保价250
      '20162345': [180, 200],    // 保价200
      // group4 - 保价150, 120, 90
      '20162346': [135, 150],    // 保价150
      '20162347': [108, 120],    // 保价120
      '20162348': [81, 90],      // 保价90
      // group5 - 保价60, 竞价, 保价0
      '20162349': [54, 60],      // 保价60
      '20162350': [20, 24],      // 竞价
