...
export function useAdManager(config: AdConfig) {
  ...
  const generateSimulatedEcpm = (slotId: string): number => {
    const ecpmRanges: { [key: string]: [number, number] } = {
      // group1 - 保价800, 700, 600
      '20123714': [720, 800],    // 保价800
      '19855876': [630, 700],    // 保价700
      '19855896': [540, 600],    // 保价600
      // group2 - 保价500, 450, 400
      '19872755': [450, 500],    // 保价500
      '19872753': [405, 450],    // 保价450
      '19855901': [360, 400],    // 保价400
