...
export function useAdManager(config: AdConfig) {
  ...
  const generateSimulatedEcpm = (slotId: string): number => {
    const ecpmRanges: { [key: string]: [number, number] } = {
      '19547240': [1900, 2000], // 保价2000
      '19525935': [1710, 1800], // 保价1800
      '19525937': [1425, 1500], // 保价1500
      '19547241': [1187, 1250], // 保价1250
      '19525938': [950, 1000],   // 保价1000
      '19525940': [855, 900],    // 保价900
      '19547244': [665, 700],    // 保价700
      '19525942': [570, 600],    // 保价600
      '19525943': [380, 400],    // 保价400
      '19547246': [238, 250],    // 保价250
      '19525945': [190, 200],    // 保价200
      '19525946': [135, 150],    // 保价150
      '19525948': [117, 130],    // 保价130
      '19525952': [20, 40],      // 保价0
      '19525950': [20, 40]       // 竞价
    };
