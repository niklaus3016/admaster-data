...
export function useAdManager(config: AdConfig) {
  ...
  const generateSimulatedEcpm = (slotId: string): number => {
    const ecpmRanges: { [key: string]: [number, number] } = {
      ...
      '20282424': [1440, 1800],  // 保价1800
      '20282460': [1200, 1500],  // 保价1500
      '20282479': [800, 1000],   // 保价1000
      // group2 - 保价800, 600, 400
      '20282490': [640, 800],    // 保价800
      '20282500': [480, 600],    // 保价600
      '20282509': [320, 400],    // 保价400
      // group3 - 保价330, 280, 230
      '20282522': [264, 330],    // 保价330
      '20282539': [224, 280],    // 保价280
      '20282565': [207, 230],    // 保价230
      // group4 - 保价180, 130, 90
