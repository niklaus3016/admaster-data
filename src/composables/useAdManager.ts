...
export function useAdManager(config: AdConfig) {
  ...
  const generateSimulatedEcpm = (slotId: string): number => {
    const ecpmRanges: { [key: string]: [number, number] } = {
      // group1 - 保价700, 650, 500
      '19756098': [630, 700],    // 保价700
      '19756106': [585, 650],   // 保价650
      '19756110': [450, 500],   // 保价500
      // group2 - 保价450, 400, 300
      '19756111': [405, 450],   // 保价450
      '19756112': [360, 400],   // 保价400
      '19756113': [270, 300],   // 保价300
      // group3 - 保价250, 200, 150
      '19756114': [225, 250],   // 保价250
      '19756115': [180, 200],   // 保价200
