...
export function useAdManager(config: AdConfig) {
  ...
  const generateSimulatedEcpm = (slotId: string): number => {
    const ecpmRanges: { [key: string]: [number, number] } = {
      // group1 - 保价1500, 1250, 1000
      '20284960': [1200, 1500],  // 保价1500
      '20285041': [1000, 1250],  // 保价1250
      '20285082': [800, 1000],   // 保价1000
      // group2 - 保价800, 600, 400
      '20285118': [640, 800],    // 保价800
      '20285187': [480, 600],    // 保价600
      '20285220': [320, 400],    // 保价400
      // group3 - 保价300, 200, 100
