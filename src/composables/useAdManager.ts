...
export function useAdManager(config: AdConfig) {
  ...
  const generateSimulatedEcpm = (slotId: string): number => {
    const ecpmRanges: { [key: string]: [number, number] } = {
      // group1 - 保价810, 720, 630
      '20217119': [720, 810],    // 保价810
      '20217121': [630, 720],    // 保价720
      '20217126': [540, 630],    // 保价630
      // group2 - 保价540, 450, 360
      '20217131': [450, 540],    // 保价540
      '20217135': [360, 450],    // 保价450
      '20217142': [270, 360],    // 保价360
      // group3 - 保价270, 180, 90
      '20217149': [180, 270],    // 保价270
      '20217154': [90, 180],     // 保价180
      '20217165': [45, 90],      // 保价90
      // group4 - 保价45, 竞价, 保价0
      '20217166': [40, 45],      // 保价45
      '20217167': [20, 24],      // 竞价
