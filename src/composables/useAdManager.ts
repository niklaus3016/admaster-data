...
export function useAdManager(config: AdConfig) {
  ...
  // 广告位分组配置（问月塔罗 0909，含1个竞价位20354604）
  const AD_GROUPS = {
    group1: [
      '20354590', // 保价1220
      '20354591', // 保价920
    ...
    group5: [
      '20344926', // 保价30
      '20354604', // 竞价(setfloor:2000)
      '20340764', // 保价0
    ],
  }; // 共15个广告位（问月塔罗 0909，含1个竞价位20354604）
  ...
  const generateSimulatedEcpm = (slotId: string): number => {
    const ecpmRanges: { [key: string]: [number, number] } = {
      // group1 - 保价1220, 920, 720
      '20354590': [920, 1220],  // 保价1220
      '20354591': [720, 920],   // 保价920
      '20354592': [500, 720],   // 保价720
      // group2 - 保价500, 400, 300
      '20344870': [400, 500],   // 保价500
      '20344873': [320, 400],   // 保价400
      '20340671': [240, 300],   // 保价300
      // group3 - 保价250, 200, 150
      '20354631': [200, 250],   // 保价250
      ...
      // group5 - 保价30, 竞价, 保价0
      '20344926': [26, 30],     // 保价30
      '20354604': [10, 20],     // 竞价(setfloor:2000)
      '20340764': [10, 10],     // 保价0
    };
