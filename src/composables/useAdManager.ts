...
export function useAdManager(config: AdConfig) {
  ...
  const generateSimulatedEcpm = (slotId: string): number => {
    const ecpmRanges: { [key: string]: [number, number] } = {
      ...
      '20275529': [1160, 1450],  // 保价1450
      '20275548': [1000, 1250],  // 保价1250
      '20275575': [680, 850],    // 保价850
      // group2 - 保价650, 450, 350
      '20275612': [520, 650],    // 保价650
      '20275613': [360, 450],    // 保价450
      '20275623': [280, 350],    // 保价350
      // group3 - 保价300, 250, 200
      '20275634': [240, 300],    // 保价300
      '20275645': [200, 250],    // 保价250
      '20275655': [160, 200],    // 保价200
      // group4 - 保价150, 竞价, 保价80
      '20275661': [120, 150],    // 保价150
      '20275662': [90, 100],     // 竞价(setbid:12000)
      '20275666': [72, 80],      // 保价80
      // group5 - 保价50, 竞价, 保价0
      '20275682': [40, 50],      // 保价50
