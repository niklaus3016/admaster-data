...
export function useAdManager(config: AdConfig) {
  ...
  const generateSimulatedEcpm = (slotId: string): number => {
    const ecpmRanges: { [key: string]: [number, number] } = {
      '19756093': [1710, 1800], // 保价1800
      '19756094': [1425, 1500], // 保价1500
      '19756095': [950, 1000],  // 保价1000
      '19756098': [665, 700],   // 保价700
      '19756106': [618, 650],   // 保价650
      '19756107': [570, 600],   // 保价600
      '19756110': [475, 500],   // 保价500
      '19756111': [428, 450],   // 保价450
      '19756112': [380, 400],   // 保价400
      '19767798': [333, 350],   // 保价350
      '19756113': [285, 300],   // 保价300
      '19756114': [238, 250],   // 保价250
      '19756115': [190, 200],   // 保价200
      '19756116': [135, 150],   // 保价150
      '19756117': [90, 100],    // 保价100
      '19767830': [72, 80]      // 保价80
      // '19760876': [20, 40],     // 保价0（暂时注释）
      // '19756118': [20, 40]      // 竞价（暂时注释）
    };
