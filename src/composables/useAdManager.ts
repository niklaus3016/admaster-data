...
export function useAdManager(config: AdConfig) {
  ...
  // 广告位分组配置（永喜灵签 0903，含2个竞价位20275692和20308341）
  const AD_GROUPS = {
    group1: [
      '20275613', // 保价450
      '20275634', // 保价300
    ...
    group6: [
      '20308341', // 竞价(setbid:1000)
      '20308350', // 保价10
    ],
  }; // 共17个广告位（永喜灵签 0903，含2个竞价位20275692和20308341）
  ...
  const isBiddingSlot = (slotId: string): boolean => {
    const biddingSlots = ['20275692', '20308341']; // 永喜灵签 0903竞价位；后续有竞价直接加入ID即可
