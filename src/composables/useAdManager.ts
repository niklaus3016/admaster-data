...
export function useAdManager(config: AdConfig) {
  ...
  // 广告位分组配置（问月塔罗 0908，含1个竞价位20340749）
  const AD_GROUPS = {
    group1: [
      '20340547', // 保价1500
      '20340575', // 保价1250
    ...
    group5: [
      '20340737', // 保价50
      '20340749', // 竞价(setbid:3000)
      '20340764', // 保价0
    ],
  }; // 共15个广告位（问月塔罗 0908，含1个竞价位20340749）
  ...
  const generateSimulatedEcpm = (slotId: string): number => {
    const ecpmRanges: { [key: string]: [number, number] } = {
      // group1 - 保价1500, 1250, 850
      '20340547': [1200, 1500], // 保价1500
      '20340575': [1000, 1250], // 保价1250
      '20340597': [680, 850],   // 保价850
      // group2 - 保价650, 450, 350
      '20340639': [520, 650],   // 保价650
      '20340652': [360, 450],   // 保价450
      '20340661': [280, 350],   // 保价350
      // group3 - 保价300, 250, 200
      '20340671': [240, 300],   // 保价300
      '20340688': [200, 250],   // 保价250
      '20340706': [160, 200],   // 保价200
      // group4 - 保价150, 120, 80
