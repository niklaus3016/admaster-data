...
export function useAdManager(config: AdConfig) {
  ...
  const generateSimulatedEcpm = (slotId: string): number => {
    const ecpmRanges: { [key: string]: [number, number] } = {
      // group1 - 保价1100, 900, 700
      '20119538': [800, 1000],   // 保价1100
      '20119545': [720, 810],    // 保价900
      '20119547': [560, 630],    // 保价700
      // group2 - 保价420, 320, 270
      '20119575': [336, 378],    // 保价420
      '20119944': [256, 288],    // 保价320
      '20119952': [243, 270],    // 保价270
      // group3 - 保价220, 170, 120
      '20119985': [200, 220],    // 保价220
      '20120004': [153, 170],    // 保价170
      '20120021': [108, 120],    // 保价120
      // group4 - 保价90, 70, 50
      '20120031': [81, 90],      // 保价90
      '20120034': [63, 70],      // 保价70
      '20120039': [45, 50],      // 保价50
