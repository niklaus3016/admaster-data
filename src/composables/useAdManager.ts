...
export function useAdManager(config: AdConfig) {
  ...
  // 广告位分组配置（潮序圣杯 0901，含1个竞价位20289271）
  const AD_GROUPS = {
    group1: [
      '20094437', // 保价600
      '20098708', // 保价500
    ...
    group4: [
      '20098699', // 保价50
      '20094552', // 保价30
      '20289271', // 竞价(setbid:2000)
    ],
    group5: [
      '20094771', // 保价0
    ],
  }; // 共13个广告位（潮序圣杯 0901，含1个竞价位20289271）
  ...
  const generateSimulatedEcpm = (slotId: string): number => {
    const ecpmRanges: { [key: string]: [number, number] } = {
      // group1 - 保价600, 500, 400
      '20094437': [480, 540], // 保价600
      '20098708': [400, 450], // 保价500
      '20094461': [320, 360], // 保价400
      // group2 - 保价350, 300, 250
      '20112492': [280, 315], // 保价350
      '20094480': [240, 270], // 保价300
      '20098688': [225, 250], // 保价250
      // group3 - 保价180, 120, 70
