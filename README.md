...
### v1.3.0 (2026-08-29) - 云序择名第三版广告位

- ✅ 应用重命名为「云序择名」，包名更新为 `com.yunxuzeming.app`
- ✅ 更新广告位配置（第三版15个广告位，5组×3，串行轮询）
- ✅ 竞价广告位 19485371，底价 5000 分（setBidFloor）
- ✅ 统一百度应用ID为 `a48e7910`（原生SDK与前端adConfig一致）
- ✅ 全量替换应用图标（15个mipmap图标）

### v1.2.0 (2026-08-16) - 云序择名预加载优化
