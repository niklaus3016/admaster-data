...
### v1.3.0 (2026-08-29) - 极序测速第三版广告位

- ✅ 应用重命名为「极序测速」，包名更新为 `com.jixucesu.app`
- ✅ 更新广告位配置（第三版15个广告位，5组×3，串行轮询）
- ✅ 竞价广告位 19485371，底价 5000 分（setBidFloor）
- ✅ 更新百度广告AppId为 `2882303761520521728`，原生SDK App ID为 `d248ca67`
- ✅ 全量替换应用图标（15个mipmap图标）

### v1.2.0 (2026-08-16) - 极序测速预加载优化
...
### v1.1.0 (2026-06-13) - 极序测速

- ✅ 应用重命名为「极序测速」
- ✅ 更新应用包名为 `com.jixucesu.app`
- ✅ 更新广告位配置（15个广告位）
- ✅ 更新百度广告AppId
- ✅ 更新应用图标
- ✅ 调整eCPM高值传输比例为30%

### v1.0.1 (2026-04-14) - 极序测速广告正式版
